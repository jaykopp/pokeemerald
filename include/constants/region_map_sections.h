...
#define MAPSEC_QUIET_WOODS                  0xD5
#define MAPSEC_FERNET_TOWN                  0xD6
#define MAPSEC_BERRY_VILLAGE                0xD7
#define MAPSEC_PYRE_PROMENADE               0xD8
#define MAPSEC_FERNET_WOODS                 0xD9
