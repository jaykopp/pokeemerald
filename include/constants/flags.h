...
#define FLAG_INGAME_WINGULL_TRADE            0x96 // Nytt flagg for Wingull
...
#define FLAG_DEFEATED_RIVAL_FERNET_WOODS     0x1DA // New Flag
...
#define FLAG_HIDDEN_ITEM_FERNET_WOODS_POTION                 (FLAG_HIDDEN_ITEMS_START + 0x63)
...
#define FLAG_FERNET_TOWN_SPEECH         0x264 // New Flag
...
#define FLAG_ROUTE118_LITTLE_BOY        0x26A // New flag
...
#define FLAG_ITEM_FERNET_WOODS_ETHER                                0x455
...
#define FLAG_VISITED_FERNET_TOWN                    (SYSTEM_FLAGS + 0x21) // New flag
#define FLAG_VISITED_BERRY_VILLAGE                  (SYSTEM_FLAGS + 0x22) // New flag
