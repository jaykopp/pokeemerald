static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_FERNET_TOWN - 1] = {MAP_GROUP(FERNET_TOWN), MAP_NUM(FERNET_TOWN), 31, 6},
    [HEAL_LOCATION_BERRY_VILLAGE - 1] = {MAP_GROUP(BERRY_VILLAGE), MAP_NUM(BERRY_VILLAGE), 11, 16},
    [HEAL_LOCATION_ISOGLADE_VILLAGE - 1] = {MAP_GROUP(ISOGLADE_VILLAGE), MAP_NUM(ISOGLADE_VILLAGE), 10, 11},
};
