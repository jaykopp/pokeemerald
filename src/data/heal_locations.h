static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_FERNET_TOWN - 1] = {MAP_GROUP(FERNET_TOWN), MAP_NUM(FERNET_TOWN), 27, 5},
    [HEAL_LOCATION_BERRY_VILLAGE - 1] = {MAP_GROUP(BERRY_VILLAGE), MAP_NUM(BERRY_VILLAGE), 0, 0},
};
