...
const u32 gTrainerFrontPic_Worker[] = INCBIN_U32("graphics/trainers/front_pics/ruby_sapphire_may_front_pic.4bpp.lz");
const u32 gTrainerPalette_Worker[] = INCBIN_U32("graphics/trainers/palettes/ruby_sapphire_may.gbapal.lz");
