...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_JAX] = REMATCH(TRAINER_JAX_1, TRAINER_JAX_2, TRAINER_JAX_3, TRAINER_JAX_4, TRAINER_JAX_5, ROUTE123),
    ...
    [REMATCH_WATTSON] = REMATCH(TRAINER_ELRIC_1, TRAINER_WATTSON_2, TRAINER_WATTSON_3, TRAINER_WATTSON_4, TRAINER_WATTSON_5, MAUVILLE_CITY),
